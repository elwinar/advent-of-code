       ...
       PROGRAM-ID. AdventOfCode2019-9b.
       ...
       01 Asm.
          02 FILLER        OCCURS 9999 TIMES.
             ...
             03 FILLER     REDEFINES Op.
                ...
                04 OpCode  PIC 9(2).
          02 OpPtr         PIC 9(5).
          02 Inputs        PIC S9(20) OCCURS 99 TIMES.
          02 InputsLen     PIC 9(2).
          02 InputPtr      PIC 9(2).
          02 Outputs       PIC S9(20) OCCURS 99 TIMES.
       ...
       ExecuteAsm SECTION.
           ...
           PERFORM UNTIL OpPtr IS GREATER THAN SrcLen
            ...
            EVALUATE OpCode(OpPtr)
             ...
             WHEN OTHER DISPLAY "Invalid Op" " " OpCode(OpPtr) STOP RUN
            END-EVALUATE
