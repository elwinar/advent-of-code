       ...
       PROGRAM-ID. AdventOfCode2019-11b.
       ...
       01 Hull.
          02 Row OCCURS 99 TIMES.
             03 Pane PIC 9(1) VALUE 0 OCCURS 99 TIMES.
       ...
       Begin.
           ...
           MOVE 50 TO Ord.
           MOVE 'N' TO Dir.
           MOVE 1 TO Pane(Abs, Ord).

           PERFORM FOREVER

            MOVE 1 TO InputPtr
            MOVE 1 TO InputsLen
            MOVE Pane(Abs, Ord) TO Inputs(InputsLen)
            ...
            MOVE Outputs(1) TO Pane(Abs, Ord)
           ...
           PERFORM VARYING Ptr FROM 1 UNTIL Ptr > 99
            DISPLAY Row(Ptr)
           END-PERFORM.
